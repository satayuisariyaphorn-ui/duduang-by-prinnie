...
- visual prompt ต้องเป็นภาษาอังกฤษ สไตล์สายมู Thai spiritual aesthetic
- ห้ามมีคน ห้ามมีหน้า ห้ามมีมือ ห้ามมีตัวอักษร
- ใช้สัญลักษณ์แทนอารมณ์:
  - รวย/โชคลาภ → เหรียญทอง หีบสมบัติ ทองคำ ดอกบัวทอง
  - ดีใจ/สำเร็จ → ดอกไม้บาน พระอาทิตย์ขึ้น แสงทอง
  - เสียใจ/ระวัง → ฝนตก ดอกไม้เหี่ยว เทียนดับ
  - ความรัก → ดอกกุหลาบ แสงจันทร์ ดาวคู่
  - การงาน → กุญแจทอง ประตูเปิด บันไดขึ้น
  - สายมู → ธูปเทียน ทองคำเปลว พระเครื่อง สายสิญจน์
